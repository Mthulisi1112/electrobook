...
@section('title', 'Add Electrician')

@section('content')
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-[#1e3a5f]">Add New Electrician</h1>
        <p class="text-gray-600 mt-2">Create a new electrician account and profile</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.electricians.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="hourly_rate" id="hourly_rate" value="{{ old('hourly_rate') }}" required
                               step="0.01" min="0"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bio" id="bio" rows="4"
                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#3b82f6] focus:ring-[#3b82f6]">{{ old('bio') }}</textarea>
                    @error('bio')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="space-y-2" x-data="{ areas: {{ json_encode(old('service_areas', [])) }} }">
